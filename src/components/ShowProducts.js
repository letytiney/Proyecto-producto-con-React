...
const ShowProducts = () => {
    const url = 'http://localhost/api-products-main/api-products-main/';
                                    ...
                                    <tbody className="table-group-divider">
                                        {products.map((product, i) =>(
                                            <tr key={product.id}>
                                                ...
                                                <td>{new Intl.NumberFormat('es-GT',{style: 'currency',currency: 'GTQ',}).format(product.price)}</td>
                                                <td>
                                                    <button onClick={() => openModal(2,product.id, product.name, product.description, product.price)}
                                                    className="btn btn-warning" data-bs-toggle='modal' data-bs-target='#modalProducts'>
                                                        <i className="fa-solid fa-edit"></i>
                                                    </button>
                                                    <button onClick={() => borrarProducto(product.id, product.name)} className="btn btn-danger">
